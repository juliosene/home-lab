...
# URL for the Portainer stack
PORTAINER_STACK_URL="https://downloads.portainer.io/ce2-21/portainer-agent-stack.yml"
...
if [ $TOKEN == 0 ]; then
    ...
    if [ "$SWARM_STATUS" == "active" ]; then
        ...
        curl -L $PORTAINER_STACK_URL -o portainer-agent-stack.yml
